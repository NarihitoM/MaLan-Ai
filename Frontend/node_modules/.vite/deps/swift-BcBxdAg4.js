...
//#region node_modules/highlight.js/lib/languages/swift.js
var require_swift = /* @__PURE__ */ __commonJS({ "node_modules/highlight.js/lib/languages/swift.js": ((exports, module) => {
	/**
	* @param {string} value
	* @returns {RegExp}
	* */
		...
		return {
			...
			contains: [
				...
				INIT_SUBSCRIPT,
				{
					...
					excludeEnd: true,
					keywords: KEYWORDS,
					contains: [hljs.inherit(hljs.TITLE_MODE, { begin: /[A-Za-z$_][\u00C0-\u02B80-9A-Za-z$_]*/ }), ...KEYWORD_MODES]
				},
...
//#endregion
export { require_swift };
//# sourceMappingURL=swift-BcBxdAg4.js.map