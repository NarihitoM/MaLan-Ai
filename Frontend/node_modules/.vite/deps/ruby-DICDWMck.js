...
//#region node_modules/highlight.js/lib/languages/ruby.js
var require_ruby = /* @__PURE__ */ __commonJS({ "node_modules/highlight.js/lib/languages/ruby.js": ((exports, module) => {
	/**
	* @param {string} value
	* @returns {RegExp}
	* */
		...
		const STRING = {
			...
			variants: [
				...
				{ begin: /\B\?\\?\S/ },
				{
					begin: /<<[-~]?'?(\w+)\n(?:[^\n]*\n)*?\s*\1\b/,
					returnBegin: true,
					contains: [{ begin: /<<[-~]?'?/ }, hljs.END_SAME_AS_BEGIN({
						begin: /(\w+)/,
						end: /(\w+)/,
						contains: [hljs.BACKSLASH_ESCAPE, SUBST]
					})]
...
//#endregion
export { require_ruby };
//# sourceMappingURL=ruby-DICDWMck.js.map