...
//#region node_modules/highlight.js/lib/languages/mathematica.js
var require_mathematica = /* @__PURE__ */ __commonJS({ "node_modules/highlight.js/lib/languages/mathematica.js": ((exports, module) => {
	var SYSTEM_SYMBOLS = [
		"AASTriangle",
		"AbelianGroup",
		"Abort",
	...
	*/
	...
	function mathematica(hljs) {
		const BASE_NUMBER_RE = either(concat(/([2-9]|[1-2]\d|[3][0-5])\^\^/, /(\w*\.\w+|\w+\.\w*|\w+)/), /(\d*\.\d+|\d+\.\d*|\d+)/);
		const APPROXIMATE_NUMBER_RE = either(/``[+-]?(\d*\.\d+|\d+\.\d*|\d+)/, /`([+-]?(\d*\.\d+|\d+\.\d*|\d+))?/);
		const NUMBERS = {
			className: "number",
			relevance: 0,
			begin: concat(BASE_NUMBER_RE, optional(APPROXIMATE_NUMBER_RE), optional(/\*\^[+-]?\d+/))
		};
...
//#endregion
export { require_mathematica };
//# sourceMappingURL=mathematica-Ch2TVAs6.js.map